...
using SummaryEngine.Adapter.Github.GithubAdapter.Clients;
using SummaryEngine.Adapter.Github.GithubAdapter.Interfaces;
using SummaryEngine.Adapter.Github.GithubAdapter.Services;
using SummaryEngine.Domain.Interfaces.External.Git;

namespace SummaryEngine.Adapter.Github.GithubAdapter.DependencyInjection;
