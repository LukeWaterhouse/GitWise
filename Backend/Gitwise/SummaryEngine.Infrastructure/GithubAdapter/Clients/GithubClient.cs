...
using SummaryEngine.Adapter.Github.GithubAdapter.Common.Constants;
...
using SummaryEngine.Adapter.Github.GithubAdapter.Models.Search;

namespace SummaryEngine.Adapter.Github.GithubAdapter.Clients;
